# Contributing to KumuluzEE Metrics

♥ [KumuluzEE Metrics](https://github.com/kumuluz/kumuluzee-metrics) and want to get involved?
...
**[File a bug report](https://github.com/kumuluz/kumuluzee-metrics/issues/)**
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/kumuluzee-metrics.git
   # Navigate to the newly cloned directory
   cd kumuluzee-metrics
   # Assigns the original repo to a remote called "upstream"
   git remote add upstream https://github.com/kumuluz/kumuluzee-metrics.git
   ```
