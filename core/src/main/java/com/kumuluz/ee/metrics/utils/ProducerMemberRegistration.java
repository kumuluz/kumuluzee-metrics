...
public class ProducerMemberRegistration {
    ...
    private MetadataWithTags metadata;

    public ProducerMemberRegistration(Bean bean, AnnotatedMember member, MetadataWithTags metadata) {
        this.bean = bean;
        this.member = member;
    ...
    public MetadataWithTags getMetadata() {
        return metadata;
    }
}
