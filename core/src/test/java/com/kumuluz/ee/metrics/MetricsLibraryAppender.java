...
public class MetricsLibraryAppender extends CachedAuxilliaryArchiveAppender {
    ...
    protected Archive<?> buildArchive() {
        ...
        return ShrinkWrap.create(JavaArchive.class, "kumuluzee-metrics-core.jar")
                .addPackages(true, MetricsExtension.class.getPackage())
                .addAsServiceProvider(com.kumuluz.ee.common.Extension.class, MetricsExtension.class)
                .addAsServiceProvider(javax.enterprise.inject.spi.Extension.class, MetricsExtensionCDI.class)
